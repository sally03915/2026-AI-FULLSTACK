...
2) security : Jwt + Redis
  com.thejoa703.security
    ...
    ㄴJwtProvider    (2)  발급
    ㄴTokenStore     (3)  redis 보관  /   RedisConfig / SecurityConfig
...
※ 수업진행공지
어제 진행한 프로젝트 결과물을 카카오톡 단체방에 업로드했습니다.
부득이하게 지각·조퇴·결석으로 수업을 놓치신 분들은 파일 다운로드 후 내용을 미리 확인하시고 오늘 수업을 준비해 주시기 바랍니다.
